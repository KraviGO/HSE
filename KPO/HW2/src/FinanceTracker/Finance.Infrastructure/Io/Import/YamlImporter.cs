...
public sealed class YamlImporter : IImportService
{
    ...
    public async Task ImportAsync(string path, CancellationToken ct = default)
    {
        ...
        var deserializer = new DeserializerBuilder()
            ...
            .Build();
        var dto = deserializer.Deserialize<YamlDto>(raw) ?? throw new InvalidOperationException("Invalid YAML.");
